<template>
  <section class="bg-base-foreground">
    ...
    >
      TaxonWorks
    </a> following specialized scientific literature. Specimen records and images are the product of the curation, identification, imaging and digitization of Attelabidae in the ASU O'Brien Collection.   
          </p>
         </div>
      </div>
    </div>
